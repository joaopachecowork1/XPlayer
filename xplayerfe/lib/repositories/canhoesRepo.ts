...
export const canhoesRepo = {
  ...
  getState: () => xplayerFetch<T.CanhoesStateDto>("/canhoes/state"),

  getCategories: () => xplayerFetch<T.AwardCategoryDto[]>("/canhoes/categories"),

  getMeasures: () => xplayerFetch<T.GalaMeasureDto[]>("/canhoes/measures"),

  getResults: () => xplayerFetch<T.CanhoesCategoryResultDto[]>("/canhoes/results"),
  ...
  myVotes: () => xplayerFetch<T.VoteDto[]>("/canhoes/my-votes"),
  ...
  myUserVotes: () => xplayerFetch<T.UserVoteDto[]>("/canhoes/my-user-votes"),
  ...
  getMembers: () => xplayerFetch<T.PublicUserDto[]>("/canhoes/members"),

  // ==========================================
  // PUBLIC - Wishlist
  // ==========================================

  getWishlist: () => xplayerFetch<T.WishlistItemDto[]>("/canhoes/wishlist"),
  ...
  approveNominee: (id: string) =>
    xplayerFetch<T.NomineeDto>(`/canhoes/admin/nominees/${id}/approve`, { method: "POST" }),

  rejectNominee: (id: string) =>
    xplayerFetch<T.NomineeDto>(`/canhoes/admin/nominees/${id}/reject`, { method: "POST" }),
  ...
  adminApproveCategoryProposal: (id: string) =>
    xplayerFetch<T.AwardCategoryDto>(`/canhoes/admin/categories/${id}/approve`, { method: "POST" }),

  adminRejectCategoryProposal: (id: string) =>
    xplayerFetch<T.CategoryProposalDto>(`/canhoes/admin/categories/${id}/reject`, { method: "POST" }),

  adminApproveMeasureProposal: (id: string) =>
    xplayerFetch<T.GalaMeasureDto>(`/canhoes/admin/measures/${id}/approve`, { method: "POST" }),
