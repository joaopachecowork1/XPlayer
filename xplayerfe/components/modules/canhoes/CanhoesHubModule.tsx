    ...
    <div className="space-y-4">
      ...
      <Card className="border-primary/20 bg-card/30">
        <CardHeader className="space-y-1">
          <CardTitle className="text-lg sm:text-xl">Feed da Comunidade</CardTitle>
          <div className="text-sm text-muted-foreground">
            Posts em estilo Instagram/Reddit com carrossel, reações e comentários.
          </div>
        </CardHeader>
        <CardContent>
          <HubFeedModule variant="reddit" />
        </CardContent>
      </Card>
    </div>
  );
